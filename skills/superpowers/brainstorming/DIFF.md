...
- References `writing-plans` for step 10 transition
- References `grill-with-docs` for step 5 grilling
...
| Element | v2 | v3 |
|---------|-----|-----|
| Grill content | Inline copy of grill-with-docs `<what-to-do>` + `<supporting-info>` (~80 lines) | Reference to invoke `grill-with-docs` skill |
| Step 5 wording | "enter grill-with-docs mode" | "invoke grill-with-docs to stress-test decisions" |
| Terminal state | `writing-plans` | `writing-plans` |
| Step 10 transition | Invoke `writing-plans` | Invoke `writing-plans` |
